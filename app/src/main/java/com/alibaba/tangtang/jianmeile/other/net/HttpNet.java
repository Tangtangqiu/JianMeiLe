package com.alibaba.tangtang.jianmeile.other.net;
...
import com.alibaba.tangtang.jianmeile.other.base.NetCallback;
...
public class HttpNet{
     ...
     * @param netCallback
     */
    public static void doGetHttpRequest(final String strRequestMethod,
                                        final String strUrl,
                                        final NetCallback netCallback
                                       ){
